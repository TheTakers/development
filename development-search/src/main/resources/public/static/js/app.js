...
app.factory('menuRepository',function(){
	...
	return {
		...
		getMenuData:function(){
			if(this.navId != 1){
				return [
				          {id:'1',name:'首页',icon:'glyphicon glyphicon-asterisk',url:'#/',pid:''},
			              {id:'2',name:'控制台',icon:'glyphicon glyphicon-book',url:'',pid:'',child:[
			              ...
			              {id:'3',name:'系统设置',icon:'glyphicon glyphicon-camera',url:'',pid:'',child:[
				        
		                {id:'',name:'系统菜单',icon:'glyphicon glyphicon-align-center',url:'',pid:'',child:[
		                                                                {id:'',name:'图标管理',icon:'glyphicon glyphicon-adjust',url:'',pid:''},
		                                                                {id:'',name:'菜单配置',icon:'glyphicon glyphicon-tint',url:'',pid:''}
		                                                                ]},
		                {id:'',name:'查询配置',icon:'glyphicon glyphicon-backward',url:'',pid:'',child:[
		                ...
		                {id:'',name:'用户管理',icon:'glyphicon glyphicon-th-large',url:'',pid:'',child:[]},
		                {id:'',name:'日志管理',icon:'glyphicon glyphicon-th-list',url:'',pid:'',child:[
